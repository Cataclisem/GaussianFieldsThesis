...
% ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
% Page set-up
\setlrmarginsandblock{2.75cm}{2.75cm}{1}
...
\makechapterstyle{jrmbsc}{% requires graphicx package
	...
	\renewcommand*{\chapnamefont}{%
		\fontsize{30pt}{22pt}\normalfont\color{black}\bfseries\raggedleft }
	\renewcommand*{\chaptitlefont}{%
		\normalfont\Huge\color{black}\bfseries\raggedleft}
	\renewcommand*{\chapternamenum}{}
	\renewcommand*{\printchapternum}{%
		\makebox[0pt][l]{\hspace{-0.2em}
			\resizebox{!}{5ex}{%
...
\def\Question{1} % Is it question file or not
