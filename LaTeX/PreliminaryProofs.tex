...
\begin{proof}
	...
	\end{align}
	where the last inequality comes from the fact that $0 < \lambda_1 < \lambda_{2} < \ldots$. The uniform bound comes from the fact that $\inf_{m} \lambda_{1}^{m} > 0$ \textcolor{red}{How?}
\end{proof}
...
\end{theorem}
\begin{proof}
	We will simply show that $e^{tA}$ fulfills \cref{semigroupDef}. First
	\begin{align}
	...
	\end{align}
	as $t \to 0$. And lastly \textcolor{red}{need help}
\end{proof}
