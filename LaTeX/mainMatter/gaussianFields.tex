...
\begin{equation}
	\mathcal{A} = \cbr{W(A) : A \in \mathcal{K}, \mu(A) < \infty^{\phantom{a}}}.
\end{equation} 
...
Let $s > \frac{d_h}{2d_w}$. We observe from \cref{boundsOfRieszKernel} that $G_s(x, \cd ) \in L^{2}(K, \mu)$. Moreover we have that
	\begin{equation}\label{rieszKernelAsSum}
	...
	\end{equation}
	recalling that \ref{convergenceOfEigenvaluesOfLaplcianBounds} and $\frac{1}{\Gamma(s)}\int_{K} t^{s-1} e^{-\lambda_jt} \dd t = \lambda_j^{-s}$. Furthermore note that by \Cref{convergenceOfEigenvaluesOfLaplacian} we have \eqref{rieszKernelAsSum} converges, since $s > \frac{d_h}{2d_w}$.
