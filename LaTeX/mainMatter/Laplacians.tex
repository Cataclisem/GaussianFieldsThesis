...
\begin{proof}
	...
	\medskip
	First note that if we use the substitution $t = \lambda_j u$ we get 
	\begin{align}
...
\end{coro}
\begin{proof}
	Now from the definition of $(-\Delta)^{-s}$, \cref{fracLaplacianProperties} and \cref{fractionalLaplacianIsRieszKernel}, we find that
	\begin{align}
